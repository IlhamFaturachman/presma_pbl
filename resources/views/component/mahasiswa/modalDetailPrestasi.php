            ...
            <div class="modal-footer">
                <div class="d-flex w-100 justify-content-center align-items-center">
                    <div class="row text-center">
                        ...
                        <p id="modalTotalPoint" class="m-auto fw-bold" style="font-weight: bold; font-size: 30px;"></p>
                    </div>
                </div>
            </div>
        </div>
...
document.getElementById('detailModal').addEventListener('show.bs.modal', async (event) => {
    ...
    try {
        const response = await fetch(`/presma_pbl/public/mahasiswa/prestasi/${prestasiId}`);
